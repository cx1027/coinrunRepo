...
def restore_file(restore_id, load_key='default', reload = True):
...
def setup_and_load(use_cmd_line_args=True,environment =None, **kwargs):
    """
    ...
    """
    args = Config.initialize_args(use_cmd_line_args=use_cmd_line_args, **kwargs, environment = environment)
